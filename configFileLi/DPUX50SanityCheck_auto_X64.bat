...
Set DB_info=[dbHostIP_caceyli]
rem 192.168.10.40 localhost
Set DBUSERPWD=sa/Si*****0

Set Branch_dir=[installerBranchGAOrtest_caceyli]
...
Set DownloadfilePath=[installerDowloadFromFtpDir_caceyli]%Branch_dir%
...
Set DP_Config_File_name=[DPCfgFile_caceyli]
Set UX_Config_File_name=[UXCfgFile_caceyli]
...
[calloRremcall_caceyli] :Create_SalesDemo_TASK
[calloRremcall_caceyli] :Run_SalesDemo_TASK1
[calloRremcall_caceyli] :Run_SalesDemo_TASK2
